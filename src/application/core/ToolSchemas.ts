      ...
      inputSchema: {
        ...
        properties: {
          command: {
            type: "string",
            description:
              "Optional test command. If omitted, use the project's default test command.",
          },
          workingDirectory: {
            type: "string",
      ...
      inputSchema: {
        ...
        properties: {
          ...
          development: {
            type: "boolean",
            description:
              "Whether to install the dependency as a development dependency.",
          },
        },
        required: ["package"],
      },
      ...
      inputSchema: {
        ...
        properties: {
          ...
          checkout: {
            type: "boolean",
            description:
              "Whether to switch to the new branch after creating it.",
          },
        },
        required: ["name"],
      },
      ...
      inputSchema: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Optional symbol kind, such as class, function, interface, or variable.",
          },
        },
        required: ["name"],
      },
      ...
      inputSchema: {
        ...
        properties: {
          ...
          question: {
            type: "string",
            description:
              "Specific question or aspect of the code to analyze.",
          },
        },
        required: ["path"],
      },
      ...
      inputSchema: {
        ...
        properties: {
          path: {
            type: "string",
            description:
              "Path to the source file or directory to format.",
          },
          check: {
            type: "boolean",
            description:
